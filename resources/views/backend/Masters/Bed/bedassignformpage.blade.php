...
<section class="table-components">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3" style="border-right: 1px solid #ccc;">
                                    ...
                                    <form enctype="multipart/form-data" name="bedAssignForm" id="bedAssignForm">
                                        <div class="form-group">
                                            <label for="bed_id">Select Bed Name</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="bed_numbers" class="row">
                                                @if(isset($cabininfo))
                                                            ...
                                                            <input type="hidden" id="cattypeid" name="cattypeid" value="{{$cabininfo->cabintype->id}}">
                                                ...
                                                @elseif(isset($wardinfo))
                                                            ...
                                                            <input type="hidden" id="cattypeid" name="cattypeid" value="{{$wardinfo->wardtype->id}}">
                                                ...
                                                @elseif(isset($icuinfo))
                                                            ...
                                                            <input type="hidden" id="cattypeid" name="cattypeid" value="{{$icuinfo->icutype->id}}">
    ...
    <div class="row">
        @if(isset($bedassigned))
            @foreach($bedassigned as $bedName => $assignedGroup)
                @php
                    $firstAssigned = $assignedGroup->first();
                @endphp
                <p style="font-size:14px">{{ $firstAssigned->bed_name }}</p> <!-- Display the bed name -->
