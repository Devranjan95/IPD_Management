            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        <form enctype="multipart/form-data" name="permissionform" id="permissionform">
                            <input type="hidden" id="saveurl" value="{{ url('permission/saveData') }}" />
                            <input type="hidden" id="recordid" name="recordid" value="" />
                            <input type="hidden" id="mode" name="mode">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5 text-dark" id="exampleModalLabel">Manage Screens</h1>
                            ...
                            <div class="modal-body" style="color:black;font-weight:600">
                                ...
                                <div class="row pb-3">
                                    <div class="col-md-6">
                                        <label for="block" class="form-label">Screen Name<span style="color:red" title="Mandatory">*</span></label>
                                        <input type="text" class="form-control" placeholder="Enter screen Name" id="permissionname" name="permissionname">
                                    </div>
                                    <div class="col-md-6">
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href='#' class='editbtn'  onclick='showEdit({{ $pr->id }})'
                                                            title='Edit'><img src='assets/previous/user.svg'
                                                                style='height:20px; width:20px' /></a>&nbsp&nbsp
                                                        <a href='javascript:void(0)'
                                                            onclick="deleteData('{{ url('permission/deleteData') }}/{{ $pr->id }}')"
...
function showEdit(id) {
    ...
    $.ajax({
        url: "{{ url('permission/editData') }}/" + id,
        headers: {
            '_token': '{{ csrf_token() }}'
        },
        type: "GET",
