                                ...
                                <div class='row pb-2'>
                                    <div class='col-lg-6'>
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active text-warning" aria-current="page">ICU Types</li>
                                        </ol>
                                    </nav>
                                    </div>
    ...
    $(document).ready(function() {
        ...
        $("#icutypeform").validate({
            ...
            submitHandler: function(form) {
                ...
                if (status == 'Inactive') {
                    if (!confirm('Changing the status to inactive will affect icus. Do you still want to proceed ?')) {
                        return false;
                    }
                }
                // $.ajax({
